		...
		this.tokenRefs = new Object();
                        ...
                        data.reprPoint[1] + "&lng=" + data.reprPoint[0] + "&username=ryanfb",
                        {
                            ...
                            success: function (data) {
                                ...
                                if (data.countryName) {
                                    ...
                                    var res = _results[ii];
                                    this.tokenRefs[res[1]].country = modern_country;
                        ...
                        data.reprPoint[1] + "&lng=" + data.reprPoint[0] + "&username=ryanfb",
                        {
                            ...
                            success: function (data) {
                                ...
                                if (data.countryName) {
                                    ...
                                    this.tokenRefs[0].country = modern_country;
                ...
                function getTokenRef(_results, ii) {
                    if(ii ==_results.length) {
                        this.tokenRefs2 = this.tokenRefs;
                        return;
                    }
                    var res = _results[ii];
                    this.tokenRefs[res[1]] = {};
                    this.tokenRefs[res[1]].tokenString = res[2];
                    this.tokenRefs[res[1]].id = res[1];
                    this.tokenRefs[res[1]].name = res[0] + "";
                    this.tokenRefs[res[1]].placeLink = "http://pleiades.stoa.org/places/" + res[1];
                    this.tokenRefs[res[1]].country = "";
                    $.ajax("/pleiades-geojson/geojson/" + res[1] + ".geojson", {
                        ...
                        success: function (data) {
                            this.tokenRefs[res[1]].dsp = data.description;
                            var rec = true;
